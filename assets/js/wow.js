...
/* ---------- 3) live operations map (homepage [data-opsmap]) ---------- */
(function () {
  "use strict";
  var host = document.querySelector("[data-opsmap]");
  if (!host) return;
  var STORES = [
    { n: "Morgantown #3104", x: 16, y: 32, s: "$4,120", g: "A", hot: 0 },
    { n: "Holler Lane #2087", x: 27, y: 62, s: "$3,890", g: "A", hot: 0 },
    { n: "Frankland #5521", x: 38, y: 24, s: "$3,540", g: "A", hot: 0 },
    { n: "Poplar #4410", x: 46, y: 66, s: "$3,210", g: "B", hot: 0 },
    { n: "NYC #1002", x: 57, y: 30, s: "$2,980", g: "B", hot: 0 },
    { n: "Dent #3318", x: 66, y: 58, s: "$2,740", g: "B", hot: 0 },
    { n: "Nitro #2206", x: 75, y: 34, s: "$2,210", g: "C", hot: 1 },
    { n: "Georgetown #4789", x: 85, y: 62, s: "$1,980", g: "C", hot: 1 },
    { n: "Bridgeport #5140", x: 21, y: 80, s: "$1,640", g: "D", hot: 1 },
    { n: "Rio Rancho #0142", x: 50, y: 44, s: "$6,240", g: "A", hot: 0 },
    { n: "Santa Fe #0205", x: 70, y: 76, s: "$5,030", g: "A", hot: 0 },
    { n: "Las Cruces #0305", x: 90, y: 42, s: "$4,120", g: "B", hot: 0 },
    { n: "Albuquerque #0188", x: 9, y: 54, s: "$5,910", g: "A", hot: 0 },
    { n: "Farmington #0411", x: 33, y: 46, s: "$3,880", g: "B", hot: 0 }
  ];
  host.classList.add("opsmap-built");
  var tip = document.createElement("div"); tip.className = "om-tip"; tip.setAttribute("aria-hidden", "true");
  STORES.forEach(function (st, i) {
    var pin = document.createElement("button");
    pin.type = "button"; pin.className = "om-pin g" + st.g + (st.hot ? " hot" : "");
    pin.style.left = st.x + "%"; pin.style.top = st.y + "%";
    pin.style.setProperty("--d", ((i % 6) * 0.35).toFixed(2) + "s");
    pin.setAttribute("aria-label", st.n + ", net sales " + st.s + ", health grade " + st.g);
    pin.innerHTML = '<span class="om-dot"></span>';
    function show() { tip.innerHTML = '<b>' + st.n + '</b><span class="om-row">Net sales <em>' + st.s + '</em></span><span class="om-row">Health <em class="om-g g' + st.g + '">' + st.g + '</em></span>'; tip.style.left = st.x + "%"; tip.style.top = st.y + "%"; tip.classList.add("on"); }
    function hide() { tip.classList.remove("on"); }
    pin.addEventListener("pointerenter", show); pin.addEventListener("focus", show);
    pin.addEventListener("pointerleave", hide); pin.addEventListener("blur", hide);
